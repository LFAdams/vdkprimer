...
bash $GITDIR/primerHelper2.sh -v 788chr11.29mbto31mb_woindels.recode.vcf -r /work/cemlab/reference_genomes/97103_v2.fa -c Cla97Chr11 -f 5957084 -t 10328768 -a "resistant_bulk" -b "susceptible_bulk" -o 788chr11.29mbto31mb
