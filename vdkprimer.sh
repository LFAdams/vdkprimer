...
###########################################################
/usr/local/apps/eb/VCFtools/0.1.15-foss-2016b-Perl-5.24.1/bin/vcftools --gzvcf RS_raw_snps_and_indels.vcf --recode --recode-INFO-all --indv resistant_bulk --indv susceptible_bulk --chr Cla97Chr09 --from-bp 5957084 --to-bp 10328768 --out 788chr9.5mbto10mb
...
bash $GITDIR/primerHelper2.sh -v 788chr9.5mbto10mb_woindels.recode.vcf -r /work/cemlab/reference_genomes/97103_v2.fa -c Cla97Chr05 -f 5957084 -t 10328768 -a "resistant_bulk" -b "susceptible_bulk" -o 788chr9.5mbto10mb
